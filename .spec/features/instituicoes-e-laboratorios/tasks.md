...
## T-001 — Migrations Flyway (tabelas + RLS) [concluida]
...
## T-003 — Tenant filter (servlet filter para RLS) [concluida]
...
## T-007 — Controllers REST [concluida]
...
## T-008 — Setup frontend (Biome, Zod, RHF, Router, HTTP client) [concluida]
- Refs: US-001, US-004
...
## T-014 — Testes unitários (services) [concluida]
